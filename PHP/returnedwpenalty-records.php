...
<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary shadow">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav mb-lg-0 ms-auto">
            ...
            <li class="nav-item"><a class="nav-link active" aria-current = "page" href="returnedwpenalty-records.php">Returned-penalty</a></li>
        </ul>
    ...
    <div class ="row">
    <h3 class="mb-4 text-uppercase">Returned Books</h3>
