...
<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary shadow">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav mb-lg-0 ms-auto">
            ...
            <li class="nav-item"><a class="nav-link active" aria-current="page" href="attendance(patrons)-records.php">Attendance-patrons</a></li>
    ...
    <div class ="row">
    <h3 class="mb-4 text-uppercase">Attendance - Patrons</h3>
